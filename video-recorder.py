...
argParser.add_argument("link", metavar="LINK", help="Classroom link with session token", action="store")
argParser.add_argument("duration", metavar="DURATION", type=float, help="Classroom duration", action="store")
...
driverProfile.set_preference("general.useragent.override", "Mozilla/5.0 (Windows NT 10.0; Win64; x64; rv:83.0) Gecko/20100101 Firefox/83.0")
...
timeThread = Thread(target=waitAndStopRecording, kwargs=dict(controller=controller, duration=options['duration']))
timeThread.start()
